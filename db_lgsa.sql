...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db_lgsa` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
/*Table structure for table `lgsa_cashadvance` */

DROP TABLE IF EXISTS `lgsa_cashadvance`;

CREATE TABLE `lgsa_cashadvance` (
  `lgsa_cashadvance_id` int(11) NOT NULL AUTO_INCREMENT,
  `lgsa_cashadvance_amount` float(11,2) DEFAULT NULL,
  `lgsa_employee_id` int(11) DEFAULT NULL,
  `is_created` datetime DEFAULT NULL,
  `is_updated` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`lgsa_cashadvance_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `lgsa_cashadvance` */
...
CREATE TABLE `lgsa_client` (
  ...
  `lgsa_client_working_hours` float(11,2) DEFAULT NULL,
  `lgsa_client_minimum_daily_rate` float(11,2) DEFAULT NULL,
  `lgsa_client_5_days_incentive` float(11,2) DEFAULT NULL,
  `lgsa_client_13th_month_pay` float(11,2) DEFAULT NULL,
  `lgsa_client_retirement_benefits` float(11,2) DEFAULT NULL,
  `lgsa_client_uniform_allowance` float(11,2) DEFAULT NULL,
  `lgsa_client_overtime` float(11,2) DEFAULT NULL,
  `lgsa_client_night_differential` float(11,2) DEFAULT NULL,
  `lgsa_client_sss` float(11,2) DEFAULT NULL,
  `lgsa_client_philhealth` float(11,2) DEFAULT NULL,
  `lgsa_client_pagibig` float(11,2) DEFAULT NULL,
  `lgsa_client_others` float(11,2) DEFAULT NULL,
...
insert  into `lgsa_client`(`lgsa_client_id`,`lgsa_client_business_name`,`lgsa_client_contact_person`,`lgsa_client_business_add`,`lgsa_client_tel_num`,`lgsa_client_email`,`lgsa_client_working_hours`,`lgsa_client_minimum_daily_rate`,`lgsa_client_5_days_incentive`,`lgsa_client_13th_month_pay`,`lgsa_client_retirement_benefits`,`lgsa_client_uniform_allowance`,`lgsa_client_overtime`,`lgsa_client_night_differential`,`lgsa_client_sss`,`lgsa_client_philhealth`,`lgsa_client_pagibig`,`lgsa_client_others`,`lgsa_client_status`,`is_created`,`is_updated`) values (1,'Seda Hotel','John Doe','Cebu City','54328509530','',12.00,400.00,168.33,1024.03,758.51,100.00,8279.90,1324.78,1050.00,132.48,0.00,0.00,'Active','2020-04-21 01:33:28',NULL),(2,'Bai Hotel','test','Ayala','234554353','',NULL,15000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Active','2020-04-21 13:07:33',NULL),(3,'Parklane','John Doe','Ayala','32054354354','',NULL,20000.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Active','2020-04-21 13:21:42',NULL);
...
CREATE TABLE `lgsa_collectible` (
  ...
  `lgsa_collectible_from_date` date DEFAULT NULL,
  `lgsa_collectible_to_date` date DEFAULT NULL,
  `lgsa_collectible_date_issued` date DEFAULT NULL,
  `lgsa_collectible_total` float(11,2) DEFAULT NULL,
  `lgsa_collectible_collected_amount` float(11,2) DEFAULT NULL,
  `lgsa_collectible_balance` float(11,2) DEFAULT NULL,
  `lgsa_employee_id` int(11) DEFAULT NULL,
  `lgsa_collectible_client_name` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lgsa_client_id` int(11) DEFAULT NULL,
  `lgsa_collectible_status` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
insert  into `lgsa_collectible`(`lgsa_collectible_id`,`lgsa_collectible_from_date`,`lgsa_collectible_to_date`,`lgsa_collectible_date_issued`,`lgsa_collectible_total`,`lgsa_collectible_collected_amount`,`lgsa_collectible_balance`,`lgsa_employee_id`,`lgsa_collectible_client_name`,`lgsa_client_id`,`lgsa_collectible_status`,`lgsa_collectible_ar_or`,`lgsa_collectible_date_collected`,`is_created`,`is_updated`) values (1,NULL,NULL,'2020-05-01',100000.00,NULL,NULL,NULL,'Seda Hotel',1,'Collectible',NULL,NULL,NULL,NULL);
...
insert  into `lgsa_count`(`lgsa_count_id`,`lgsa_count_control_name`,`lgsa_count_counter`) values (1,'employee',NULL),(2,'voucher',3),(3,'cash_advance',5),(4,'payroll',1000),(5,'billing',1001),(6,'user',NULL);
...
CREATE TABLE `lgsa_employee` (
  ...
  `lgsa_guard_client_id` int(11) DEFAULT NULL,
  `lgsa_guard_client_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `lgsa_timekeeping` (
  ...
  `lgsa_timekeeping_client_id` int(11) DEFAULT NULL,
  ...
  `lgsa_timekeeping_day_1` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_2` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_3` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_4` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_5` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_6` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_7` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_8` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_9` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_10` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_11` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_12` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_13` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_14` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_15` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_first_row_overtime` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_first_row_hours` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_first_row_no_of_days` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_16` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_17` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_18` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_19` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_20` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_21` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_22` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_23` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_24` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_25` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_26` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_27` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_28` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_29` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_30` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_day_31` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_over_total_hours` float(11,2) DEFAULT '0.00',
  `lgsa_timekeeping_no_of_days` float(11,2) DEFAULT '0.00',
...
insert  into `lgsa_user_log`(`lgsa_user_log_id`,`lgsa_user_employee_id`,`lgsa_user_log_user_account`,`lgsa_user_log_function`,`lgsa_user_log_module`,`lgsa_user_log_action`,`lgsa_user_log_date_time`) values (1,'1000','Admin','addClient','clientsController','created','2020-04-21 01:33:28'),(2,'1000','Admin','editClient','clientsController','updated','2020-04-21 12:20:36'),(3,'1000','Admin','editClient','clientsController','updated','2020-04-21 12:21:28'),(4,'1000','Admin','editClient','clientsController','updated','2020-04-21 12:22:13'),(5,'1000','Admin','editClient','clientsController','updated','2020-04-21 13:04:32'),(6,'1000','Admin','editClient','clientsController','updated','2020-04-21 13:04:40'),(7,'1000','Admin','addClient','clientsController','created','2020-04-21 13:07:33'),(8,'1000','Admin','editClient','clientsController','updated','2020-04-21 13:08:22'),(9,'1000','Admin','addClient','clientsController','created','2020-04-21 13:21:42'),(10,'1000','Admin','editClient','clientsController','updated','2020-04-21 13:22:40'),(11,'1000','Admin','editClient','clientsController','updated','2020-04-21 13:22:46'),(12,'1000','Admin','editClient','clientsController','updated','2020-05-02 15:45:42'),(13,'1000','Admin','editClient','clientsController','updated','2020-05-02 15:56:22'),(14,'1000','Admin','editClient','clientsController','updated','2020-05-02 16:42:18'),(15,'1000','Admin','editClient','clientsController','updated','2020-05-02 16:42:33'),(16,'1000','Admin','editClient','clientsController','updated','2020-05-02 16:42:46'),(17,'1000','Admin','editClient','clientsController','updated','2020-05-02 16:42:55'),(18,'1000','Admin','editClient','clientsController','updated','2020-05-02 17:05:59'),(19,'1000','Admin','editClient','clientsController','updated','2020-05-02 17:06:09');
