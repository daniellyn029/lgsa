                                                                                    ...
                                                                                    if(!empty($param['edit_high_scho'])){
                                                                                        // if(!empty($param['edit_high_year'])){
                                                                                            ...
                                                                                            $Qry->selected  =   "lgsa_guard_employee_id         = '".$param['edit_employeeid']."',
                                                                                                        ...
                                                                                                        lgsa_guard_client_id            = '".$param['edit_client_name_id']."',
                                                                                                        lgsa_guard_client_name            = '".getClientName($con, $param['edit_client_name_id'])."',
                                                                                                                ...
                                                                                                                lgsa_employee_date_hired        = '".$param['edit_date_hired']."',
                                                                                                                lgsa_employee_status            = '".$param['edit_status']."'";
